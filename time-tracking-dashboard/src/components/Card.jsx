  ...
  return <>
    <article className={`${props.color} my-5 rounded-xl lg:h-56 lg:pb-5 lg:mb-4 lg:m-0`}>
      <div className="flex justify-end h-16">
        <img src={`./src/assets/icon-${props.imagen}.svg`} alt="Imagen Work" className="bg-cover"/>
      </div>
      <div className="bg-[#1c1f4a] p-5 rounded-xl hover:bg-[#2e3479] cursor-pointer lg:">
        ...
        <img src="./src/assets/icon-ellipsis.svg" alt="icon ellipsis" className="cursor-pointer"/>
        </div>
